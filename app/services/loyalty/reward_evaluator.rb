  ...
  class RewardEvaluator
    ...
    def evaluate!
      ...
      if @user.level == "level_1"
        ...
        issue_reward("Free Coffee") if monthly_points >= 100
      end

      if @user.level == "level_2"
        issue_reward("Free Coffee") if Date.today.month == @user.date_of_birth.month
        ...
        if Date.today <= first_tx.transaction_date + 60.days &&
          ...
          issue_reward("Free Movie Ticket")
        end
      end
    end
